...
import static com.fnf.vpn.utils.VpnServiceHelper.START_VPN_SERVICE_REQUEST_CODE;
...
public class VPNCaptureActivity extends FragmentActivity {
    ...
    private void requestStoragePermission() {
        VPNLog.print("requestStoragePermission");
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        super.onRequestPermissionsResult(requestCode, permissions, grantResults);
         if(requestCode==REQUEST_STORAGE_PERMISSION){
            VPNLog.print("requestStoragePermission "+PackageManager.PERMISSION_GRANTED);
