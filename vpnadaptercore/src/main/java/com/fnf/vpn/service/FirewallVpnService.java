...
import com.fnf.vpn.Packet;
import com.fnf.vpn.ProxyConfig;
import com.fnf.vpn.R;
import com.fnf.vpn.UDPServer;
import com.fnf.vpn.VPNLog;
import com.fnf.vpn.http.HttpRequestHeaderParser;
import com.fnf.vpn.nat.NatSession;
import com.fnf.vpn.nat.NatSessionManager;
import com.fnf.vpn.processparse.PortHostService;
import com.fnf.vpn.proxy.TcpProxyServer;
import com.fnf.vpn.tcpip.IPHeader;
import com.fnf.vpn.tcpip.TCPHeader;
import com.fnf.vpn.tcpip.UDPHeader;
...
public class FirewallVpnService extends VpnService implements Runnable {
    ...
    private ParcelFileDescriptor establishVPN() throws Exception {
        ...
        //wfy
        lastVpnStartTimeFormat = TimeFormatUtil.formatYYMMDDHHMMSS(vpnStartTime).replace(":","");
        try {
